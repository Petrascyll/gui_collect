...
class CompactCheckbox(tk.Canvas):
    def __init__(self, parent, *args, text, active=False, on_change: callable, active_bg, tooltip_text='', flip=False, fill=False, font=('Arial', 16), **kwargs):
    ...
    def draw(self, total_width):
        ...
        self.text_id   = self.create_text(text_x, h//2, anchor='w', text=self.text, font=self.font, fill='#CCC')
